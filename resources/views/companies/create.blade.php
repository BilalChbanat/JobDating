                        ...
                        <div class="white-box">
                            ...
                            <form action="{{ url('companies/create') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" placeholder="Company Name" name="name" value="{{ old('name') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="location" placeholder="Location of Your company" name="location" value="{{ old('location') }}">
